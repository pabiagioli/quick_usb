...
class QuickUsb {
  ...
  static Future<Uint8List> bulkTransferIn2(
          int configuration, int interface, UsbEndpoint endpoint, int maxLength,
          {int timeout = 1000}) =>
      _platform.bulkTransferIn2(
          configuration, interface, endpoint, maxLength, timeout);
